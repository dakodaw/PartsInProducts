...
{
    public partial class Frm_ModifyPart : Form
    {
        ...
        public Frm_ModifyPart(Part oldPart)
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void RBtn_InHouse_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void RBtn_Outsourced_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        /// <summary>
        /// Saves the information in the form to a new Part Object
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Btn_AddPartSave_Click_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void CreateNewPart()
        {
            ...
            if (RBtn_InHouse.Checked == true)
            {
                ...
                newPart = new Inhouse();
                //Try to convert from textboxes to given types, then add set the values equal to those being converted
                try
                {
                ...
                {
                    // Warn the user that one or more of the types is not right, then informs user of the correct data type
                    throw new Exception(generalExceptionString);
                }
            }
            //Do the same for an Outsourced entry
            else
            {
        ...
        /// <summary>
        /// Returns whether the Part Creation was successful or not
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns the new Part that has been created
        /// </summary>
        /// <returns></returns>
